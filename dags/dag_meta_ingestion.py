...
Tabelas geradas:
    raw.meta_insights   — metricas diarias por Ad (ultimos 90 dias)
...
def meta_ads_ingestion():
    ...
    def extract_insights() -> str:
        """
        Extrai metricas no nivel de Ad (ultimos 90 dias) e carrega em raw.meta_insights.
        ...
        records = client.get_insights(days=90)
